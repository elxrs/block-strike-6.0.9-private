...
public class UI2DSprite : UIBasicSprite
{
	...
	protected override void OnUpdate()
	{
		...
		if (texture != null)
		{
			...
			if (num10 < num9)
			{
				...
				drawRegion = new Vector4(num11, 0f, 1f - num11, 1f);
			}
			else
			{
				float num12 = (num8 - num7 / num10) / num8 * 0.5f;
				drawRegion = new Vector4(0f, num12, 1f, 1f - num12);
			}
		}
	}
	...
	public override void MakePixelPerfect()
	{
		...
		Texture texture = mainTexture;
		if (!(texture == null) && (mType == Type.Simple || mType == Type.Filled || !hasBorder) && texture != null)
		{
