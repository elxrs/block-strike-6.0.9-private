...
public class UIButtonOffset : MonoBehaviour
{
	...
	private void OnPress(bool isPressed)
	{
		...
		if (enabled)
		{
			...
			TweenPosition.Begin(tweenTarget.gameObject, duration, isPressed ? (mPos + pressed) : ((!UICamera.IsHighlighted(gameObject)) ? mPos : (mPos + hover))).method = UITweener.Method.EaseInOut;
		}
	}
