...
public class UIButtonScale : MonoBehaviour
{
	...
	private void OnPress(bool isPressed)
	{
		if (enabled)
		{
			...
			TweenScale.Begin(tweenTarget.gameObject, duration, isPressed ? Vector3.Scale(mScale, pressed) : ((!UICamera.IsHighlighted(gameObject)) ? mScale : Vector3.Scale(mScale, hover))).method = UITweener.Method.EaseInOut;
		}
	}
