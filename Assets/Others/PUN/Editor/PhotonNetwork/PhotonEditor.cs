...
public class PhotonEditor : EditorWindow
{
    ...
    protected static string DocumentationLocation = "Assets/Others/PUN/PhotonNetwork-Documentation.pdf";
    ...
    protected virtual void OnGUI()
    {
        ...
        {
            BackgroundImage = AssetDatabase.LoadAssetAtPath("Assets/Others/PUN/Editor/PhotonNetwork/background.jpg", typeof(Texture2D)) as Texture2D;
        }
