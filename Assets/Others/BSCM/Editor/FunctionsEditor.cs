...
public class FunctionsEditor : EditorWindow
{
	...
	{
		GameObject go = (GameObject)Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Others/BSCM/Prefabs/Modes/Bomb/BombSettings.prefab", typeof(GameObject)));
		Selection.activeGameObject = go;
	}
...
#pragma warning restore
	...
	{
		GameObject go = (GameObject)Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Others/BSCM/Prefabs/Others/Light.prefab", typeof(GameObject)));
		go.name = "Light";
		Selection.activeGameObject = go;
	}
