...
namespace ProGrids
{
	...
	const int WINDOW_HEIGHT = 260;
		...
		[MenuItem("Tools/ProGrids/Increase NSLevel.Grid Size", true, 203)]
		[MenuItem("Tools/ProGrids/Decrease NSLevel.Grid Size", true, 202)]
		public static bool VerifyGridSizeAdjustment()
		{
			return instance != null;
		}

		[MenuItem("Tools/ProGrids/Decrease NSLevel.Grid Size", false, 202)]
		...
		[MenuItem("Tools/ProGrids/Increase NSLevel.Grid Size", false, 203)]
	...
	pb_Profiler profiler = new pb_Profiler();
		...
		{
			Undo.RecordObjects(transforms as UnityEngine.Object[], "Snap to NSLevel.Grid");
